...
<%@ include file="/WEB-INF/content/common/taglib.jsp"%>
  ...
  <meta name="keywords" content="xyl">
  <meta name="viewport"
				...
				<ul class="am-list am-list-static am-list-border">
				  <li>
				    <i class="am-icon-pencil"></i>
				   	 您的日志
				   	 <button class="am-btn am-badge-warning am-btn-xs am-fr" data-am-popover="{content: '点我管理您的日志', trigger: 'hover focus'}" onclick="javascript:location.href='${base}/blog/myblog/'">${blogSum}</button>
				  </li>
				  <li>
					  ...
					  <li>
					   <i class="am-icon-hand-o-right"></i>
						...
						<div class="am-btn-group am-btn-group-xs am-fr">
						  <button type="button" class="am-btn am-btn-secondary" onclick="javascript:location.href='${base}/blog/add/'"> 写日志</button>
