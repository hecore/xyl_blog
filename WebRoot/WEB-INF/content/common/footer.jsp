...
<footer class="am_footer">
    <div class="am_footer_con">
        ...
        <div class="am_footer_don">
            ...
            <dl>
                ...
                <dd>本网站是采用java和Amaze UI等技术自主开发而成。本网站支持注册用户发表个人网站。</dt>                 
            </dl>
        </div>
    ...
    <div class="am_info_line">Copyright(c)2017 <span>${siteName }</span> All Rights Reserved </div>
    <div class="am_info_line-beian">测试
	 ...
	 <div class="am-popup"  id="login-modal">
	  <div class="am-popup-inner">
		<div class="am-popup-hd">
		  <h4 class="am-popup-title">校友录登陆</h4>
