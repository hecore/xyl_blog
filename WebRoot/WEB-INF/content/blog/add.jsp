...
<%@ include file="/WEB-INF/content/common/taglib.jsp"%>
  ...
  <meta name="description" content="新建日志">
  <meta name="keywords" content="新建日志">
  <meta name="viewport"
	    ...
	    <div class="am-u-md-8" id="blog-main">
			...
			<form class="am-form am-form-horizontal" id="blog-add-form" method="post" action="${base}/blog/save" enctype="multipart/form-data">
			    ...
			    <div class="am-form-group">
			     ...
			     <textarea id="blog-content" name="blog.content" cols="100" rows="8" style="width:100%;height:600px;visibility:hidden;">${blog.content }</textarea>
			     <span class="blog-error">${contentMsg}</span>
			    </div>
			    <a class="am-badge am-badge-primary am-round" href="${base}/blog/changeedit/1">切换为Ueditor编辑器</a>
			    <div class="am-form-group" >
