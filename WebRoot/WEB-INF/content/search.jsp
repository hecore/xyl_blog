			...
			<div data-am-widget="tabs" class="am-tabs am-tabs-d2 am_news_tab">
			  <ul class="am-tabs-nav am-cf am_cf">
			    ...
			    <li class="" id="search-blog-li">
			      <a href="[data-tab-panel-1]" onclick="blogSearch(0);">日志</a>
			    </li>
					...
					{ "keyword": keyword,
					   ...
					   function(data){
					    ...
					    $.each( data.list, function(i, n){
					    	...
					    	html+=" </span>";
					    	html+="<span class='am_news_time'><i class='am-icon-eye'></i><span>"+n.columns.BVIEW+"</span>";
					    	html+="</span>";
					    	html+="</div>";
						...
						{ "keyword": keyword,
						   ...
						   function(data){
						    ...
						    $.each( data.list, function(i, n){
						    	...
						    	html+="<h3 class='am-list-item-hd am_list_title am_list_title_s'>";
						    	if(n.columns.TYPE=="1"){
						    		html+="<a href='"+url+"/blog/detail/"+n.columns.ID+"' class='' target='_blank'>"+n.columns.TITKLE+"</a>";
						    	}
						    	if(n.columns.TYPE=="2"){
						    		html+="<a href='"+url+"/beauty/detail/"+n.columns.ID+"' class='' target='_blank'>"+n.columns.TITLE+"</a>";
						    	}
