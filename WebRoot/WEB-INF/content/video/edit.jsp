...
<%@ include file="/WEB-INF/content/common/taglib.jsp"%>
  ...
  <meta name="keywords" content="日志,blog,美图,新建">
  <meta name="viewport"
  ...
  <script type="text/javascript">
  	function loadpre(){
		...
		$(function (){
			$("#video-pre").val('${video.pre}');
			$("#video-div").html('${video.pre}');
		})
  </script>
...
<body>
	...
	<div class="am-container " id="main">
	  ...
	  <div class="am-g am-g-fixed" >
	    <div class="am-u-md-8">
			...
			<form action="${base}/video/update/" method="post" enctype="multipart/form-data" data-am-validator onsubmit="return loadpre()">
				<input type="hidden" name="video.id" value="${video.id}">
				<div class="am-form-group">
			      <label for="video-title">标题</label>
				  <input type="text" id="video-title" name="video.title" value="${video.title }" class="am-form-field am-radius" required placeholder="请输入标题" />
			    </div>
				<div class="am-form-group">
			      <label for="video-keyword">关键字</label>
				  <input type="text" id="video-keyword" name="video.keyword" value="${video.keyword }" class="am-form-field am-radius"  placeholder="请输入关键字(关键字间以空格分开)" />
			    </div>
	             <div class="am-form-group">
			    ...
			    <div  id="video-image-div">
				  ...
				  <input id="video-image" name="upload" type="file" multiple>
	...
	<script type="text/plain" id="hidecontent" style="display: none;" >${video.content}</script>
</body>
</html>