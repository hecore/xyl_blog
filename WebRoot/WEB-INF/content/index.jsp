...
<%@ include file="/WEB-INF/content/common/taglib.jsp"%>
  ...
  <meta name="description" content="校友录主页">
  <meta name="keywords" content="校友录，太原">
  <meta name="viewport"
  ...
  <script src="${base}/js/chart/echarts-all-3.js"></script>     
	<style type="text/css">
	.am-slider-desc{
		position: fixed;
		bottom: 0px;
	    ...
	    <div class="am-u-md-8">
			...
			<c:forEach items="${blogList}" var="l">
			  			...
			  			<div class="am-g">
				  			...
				  			<div class="am-u-sm-9">
								<div class="blog-header">
						  			<span class="index-label index-label-blog">校园</span>
			  	...
			  	<c:if test="${empty l.image}">
				  	<div class="inner-box blog-img ">
						<div class="blog-header">
							<a href="${base}/blog/categorySearcher?category=${l.category}" class="blog-category">${l.categorystr }</a>
							<span class="index-label index-label-blog">校友</span>
							<h2><a href="${base}/blog/detail/${l.id}">${l.title}</a></h2>
						</div>
						<p class="blog-ext">
							<span class="blog-ext-ico">
			...
			<c:if test="${fn:length(blogList)>0}">
				<div class="wygg">
			        <dd>更多精彩<s></s></dd>
					<ul>
						<li><a href="${base}/blog/">阅读更多信息请进入日志部分，点我进入 !</a></li>
					</ul>
				 </div>
			</c:if>
			<!--  校友统计   -->
			<c:if test="${fn:length(usersList)>0}">
			    <div class="tjxy">
			        <dd>校友统计</dd>
			        <ss hidden id="usersList" > $(usersList)</ss>
			        <canvas id="xytj" val="${usersList}" style="width:100%;height:300px; "></canvas>
			        <script src="${base}/js/chart/json2.js"></script>
			        <script src="${base}/js/chart/js1.js"></script>
			    </div>
 			</c:if>
			<!-- 视频 -->
