  ...
  <div class="admin-sidebar" id="admin-sidebar">
    <ul class="am-list admin-sidebar-list">
      ...
      <li class="admin-parent">
        <a class="am-cf" data-am-collapse="{target: '#blog-nav'}"><span class="am-icon-file-word-o"></span> 日志管理 <span class="am-icon-angle-right am-fr am-margin-right"></span></a>
        <ul class="am-list am-collapse admin-sidebar-sub" id="blog-nav">
          <li><a class="am-cf" href="${base}/admins/blogList/"><span class="am-icon-list-alt"></span> 日志列表</a></li>
          <li><a href="${base}/admins/blogDeletedList/"><span class="am-icon-trash-o"></span> 已删除的日志</a></li>
        </ul>
      </li>
      <li class="admin-parent">
    ...
    <div class="am-panel am-panel-warning admin-sidebar-panel">
      ...
      <div class="am-panel-bd">
        <p>日志后台主要采用Amaze UI作为UI框架，提示层采用layer。</p>
