...
<%@ include file="/WEB-INF/content/admins/side.jsp"%> 
  ...
  <div class="admin-content" id="admin-content">
	  ...
	  function deleteBlog(id){
		//询问框
		  layer.confirm('您确定要删除该日志吗？可在删除列表中恢复，如果要永久删除请在删除列表中永久删除即可。', {
		      btn: ['确定删除','取消'],
		      title:'删除日志确认对话框'//按钮
		  }, function(){
	  ...
	  <div class="am-g">
	  	<div class="am-u-sm-12">
			<form action="${base}/admins/blogList/" method="post">
	  		...
	  		<table class="am-table am-table-bordered am-table-striped am-table-hover">
				    ...
				    <c:forEach items="${blogPage.list}" var="l">
				        <tr class="">
				            ...
				            <td>
				            	...
				            	<a class="am-btn am-btn-default am-btn-xs am-text-secondary" onclick="editBlogLevel(${l.id})"><span class="am-icon-level-up"></span> 日志等级</a>
				            </td>
				        </tr>
				    </c:forEach>
			    </tbody>
				...
				<c:set var="actionUrl" value="${base}/admins/blogList?blog.title=${blog.title}&bozhu=${bozhu}&blog.ispublic=${blog.ispublic}&blog.blevel=${blog.blevel}&page=" />
