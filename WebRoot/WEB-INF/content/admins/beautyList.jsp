		...
		<form action="${base}/admins/beautyList/" method="get">
				...
				<table class="am-table">
				  ...
				  <tr>
				    <th>美图等级</th>
				    <th>
				    	<select name="beauty.blevel" value="${beauty.blevel}">
					    	<c:if test="${empty beauty.blevel}">
			...
			<hr data-am-widget="divider" style="" class="am-divider am-divider-dashed"/>
	  		<table class="am-table am-table-bordered am-table-striped am-table-hover">
				...
				<c:set var="actionUrl" value="${base}/admins/beautyList?beauty.title=${beauty.title}&bozhu=${bozhu}&beauty.blevel=${beauty.level}&page=" />
