...
public class ToolBarCode
{
            ...
            String fileType, String savePath)
    {
        try
        {
            content = new String(content.getBytes(ToolString.encoding),
                    ToolString.encoding);// 二维码内容
     ...
     * @param savePath 保存路径
     */
    public static void encodeLogo(String content, int width, int height,
            String logoPath, String fileType, String savePath)
    {
        try
        {
            ...
            MatrixToLogoImageConfig logoConfig = new MatrixToLogoImageConfig(
                    Color.BLUE, 4);
            MatrixToImageWriterEx.writeToFile(matrix, fileType, savePath,
                    logoPath, logoConfig);
        }
        catch (Exception e)
        {
